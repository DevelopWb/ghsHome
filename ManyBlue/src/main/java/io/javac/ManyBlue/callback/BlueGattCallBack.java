            ...
            if (uuidMessage.getCharac_uuid_service() != null) {
                ...
                if (device_service != null) {
                    ...
                    if (uuidMessage.getCharac_uuid_notify() != null) {
                        ...
                        boolean notifySuccess = characteristic.setValue(BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE);
...
//        }
    ...
    public void setCharacteristic_read(BluetoothGattCharacteristic characteristic_read) {
        this.characteristic_read = characteristic_read;
    }

    public void setCharacteristic_write(BluetoothGattCharacteristic characteristic_write) {
        this.characteristic_write = characteristic_write;
    }

    public void setDevice_service(BluetoothGattService device_service) {
