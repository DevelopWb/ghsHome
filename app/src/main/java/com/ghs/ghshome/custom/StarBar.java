...
public class StarBar extends View {
    ...
    private boolean integerMark = true;//int 类型
    private boolean clickToDraw = true;//
    ...
    /**
     * 设置是否需要整数评分
     * @param clickToDraw 星星是否被画出来
     */
    public void setClickToDraw(boolean clickToDraw){
        this.clickToDraw = clickToDraw;
    }
