...
public class MineEditCustomView extends RelativeLayout {
    ...
    public MineEditCustomView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                //设置左边按钮文字颜色
            ...
            //设置右边按钮的文字
            String rightButtonText = attributes.getString(R.styleable.MineEditCustomView_right_button_text);
            if (!TextUtils.isEmpty(rightButtonText)) {
                titleBarRightTv.setText(rightButtonText);
                //设置右边按钮文字颜色
                int rightButtonTextColor = attributes.getColor(R.styleable.MineEditCustomView_right_button_text_color, Color.WHITE);
