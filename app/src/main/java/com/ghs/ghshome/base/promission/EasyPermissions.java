 ...
 */
package com.ghs.ghshome.base.promission;
...
public class EasyPermissions {
    ...
    public interface PermissionCallbacks extends
        ...
        void onPermissionsAllSelected();
        //提示给予用户权限时 取消的操作
        void onRefuseGivePromission();
        ...
        if (shouldShowRationale) {
            ...
            AlertDialog dialog = new AlertDialog.Builder(activity)
                    ...
                    .setNegativeButton(negativeButton, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            // act as if the permissions were denied  取消
                            if (object instanceof PermissionCallbacks) {
                                ((PermissionCallbacks) object).onRefuseGivePromission();
                            }
                        }
                    }).create();
            dialog.show();
    ...
    public static void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        // If 100% successful, call annotated methods  同意全部的权限
        ...
        if (object instanceof PermissionCallbacks) {
            ((PermissionCallbacks) object).onPermissionsAllSelected();
        }
    }
    ...
    public static boolean checkDeniedPermissionsNeverAskAgain(final Object object,
        ...
        for (String perm : deniedPerms) {
            ...
            if (!shouldShowRationale) {
                ...
                if (PubUtil.promissions[0].equals(perm)) {
                    msg="当前应用缺少定位权限。"+rationale;
                }else if (PubUtil.promissions[1].equals(perm)) {
                    msg="当前应用缺少存储权限。"+rationale;
                }else if (PubUtil.promissions[2].equals(perm)) {
                    msg="当前应用缺少打电话权限。"+rationale;
                }else if (PubUtil.promissions[3].equals(perm)) {
                    msg="当前应用缺少相机权限。"+rationale;
                }else if (PubUtil.promissions[4].equals(perm)) {
                    msg="当前应用缺少麦克风权限。"+rationale;
                }
