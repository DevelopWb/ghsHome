...
/**
 * Author:wang_sir
 * Time:2018/8/23 17:01
 * Description:This is BuglyConfig
 */
public class BuglyConfig {
    public static final String APP_ID = "5cd6135855"; // TODO 替换成bugly上注册的appid
    ...
    public static void init(Context context) {
         ...
         */
        Beta.largeIconId = R.mipmap.ghshome_icon;
       // 设置是否显示消息通知
         ...
         */
        Beta.smallIconId = R.mipmap.ghshome_icon;
